...
<head>
  ...
  <!-- Custom CSS -->
  <link href="css/css-plantilla/style.min.css" rel="stylesheet" />
...
<body>
  ...
  <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
          ...
          <ul class="navbar-nav float-end">
            ...
            <li class="nav-item dropdown">
              <a class="
                ...
                <img src="img/users/1.jpg" alt="user" class="rounded-circle" width="31" />
              </a>
    ...
    <aside class="left-sidebar" data-sidebarbg="skin5">
      ...
      <div class="scroll-sidebar">
        <!-- Sidebar navigation-->
        <nav class="sidebar-nav position-fixed">
          <ul id="sidebarnav" class="pt-4">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a href="icon-fontawesome.html" class="sidebar-link"><i class="mdi mdi-emoticon-cool"></i><span
                      class="hide-menu"> Font Awesome Icons </span></a>
                </li>
              </ul>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              ...
              <ul aria-expanded="false" class="collapse first-level">
                ...
                <li class="sidebar-item">
                  <a href="pages-gallery.html" class="sidebar-link"><i class="mdi mdi-multiplication-box"></i><span
                      class="hide-menu"> Gallery </span></a>
                </li>
                <li class="sidebar-item">
                  <a href="pages-calendar.html" class="sidebar-link"><i class="mdi mdi-calendar-check"></i><span
                      class="hide-menu"> Calendar </span></a>
                </li>
                <li class="sidebar-item">
                  <a href="pages-invoice.html" class="sidebar-link"><i class="mdi mdi-bulletin-board"></i><span
            ...
            <div class="card">
              ...
              <div class="comment-widgets scrollable">
                ...
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="p-2">
                    <img src="img/users/1.jpg" alt="user" width="50" class="rounded-circle" />
                  </div>
                ...
                <div class="d-flex flex-row comment-row">
                  <div class="p-2">
                    <img src="img/users/4.jpg" alt="user" width="50" class="rounded-circle" />
                  </div>
                ...
                <div class="d-flex flex-row comment-row">
                  <div class="p-2">
                    <img src="img/users/5.jpg" alt="user" width="50" class="rounded-circle" />
                  </div>
                  <div class="comment-text w-100">
                  ...
                  <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
                    <li class="list-group-item todo-item" data-role="task">
                      ...
                      <ul class="list-style-none assignedto">
                        <li class="assignee">
                          <img class="rounded-circle" width="40" src="img/users/1.jpg" alt="user"
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave" />
                        </li>
                        <li class="assignee">
                          <img class="rounded-circle" width="40" src="img/users/2.jpg" alt="user"
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica" />
                        </li>
                        <li class="assignee">
                          <img class="rounded-circle" width="40" src="img/users/3.jpg" alt="user"
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka" />
                        </li>
                        <li class="assignee">
                          <img class="rounded-circle" width="40" src="img/users/4.jpg" alt="user"
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina" />
                        </li>
                      </ul>
                    </li>
                    <li class="list-group-item todo-item" data-role="task">
          ...
          <div class="col-lg-6">
            ...
            <div class="accordion" id="accordionExample">
              ...
              <div class="card mb-0 border-top">
                <div class="card-header" id="headingTwo">
                  <h5 class="mb-0">
                    <a class="collapsed d-flex align-items-center" data-toggle="collapse" data-target="#collapseTwo"
              ...
              <div class="card mb-0 border-top">
                <div class="card-header" id="headingThree">
                  <h5 class="mb-0">
                    <a class="collapsed d-flex align-items-center" data-toggle="collapse" data-target="#collapseThree"
            ...
            <div id="accordian-4">
              <div class="card mt-4">
                ...
                <a class="card-header collapsed link border-top" data-toggle="collapse" data-parent="#accordian-4"
                  href="#Toggle-3" aria-expanded="false" aria-controls="Toggle-3">
                  <i class="seticon mdi mdi-close" aria-hidden="true"></i>
                  <span>Toggle, Closed by default</span>
                </a>
              ...
              <div class="tab-content tabcontent-border">
                <div class="tab-pane active" id="home" role="tabpanel">
                  <div class="p-20">
                    ...
                    <img src="img/background/img4.jpg" class="img-fluid" />
                  </div>
                </div>
  ...
  <!--Wave Effects -->
  <script src="js/js-plantilla/waves.js"></script>
  js\js-plantilla\waves.js
  <!--Menu sidebar -->
  <script src="js/js-plantilla/sidebarmenu.js"></script>
  <!--Custom JavaScript -->
  <script src="js/js-plantilla/custom.js"></script>
  ...
  <script src="js/js-plantilla/pages/chart/chart-page-init.js"></script>
</body>
