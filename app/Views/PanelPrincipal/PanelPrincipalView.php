        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <div class="container px-5">
                    <a class="navbar-brand" href="#">UNJBG</a>
            ...
            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false">
                <div class="carousel-inner">
                    ...
                    <img src="img/FECH-principal.jpg" class="d-block w-100 " alt="...">
                    </div>
            ...
            <!-- <header class="bg-dark py-5 ">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="img/FECH-principal.jpg" alt="..." /></div>
                    </div>
                </div>
            </header> -->
            <!-- Features section-->
